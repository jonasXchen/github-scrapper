...
pub async fn fetch_user_repos(
    ...
    loop {
        let url = format!(
            "https://api.github.com/users/{}/repos?per_page={}&page={}&sort=pushed&direction=desc",
...
pub async fn search_github_repos(queries: &[&str], github_token: &str) -> Result<Vec<String>> {
